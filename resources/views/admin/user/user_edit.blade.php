  ...
  <section class="content">
    ...
    @endif
          ...
          <div class="card card-primary">
            ...
            {!! Form::open(['url' => 'admin/user-update/'.base64_encode($data->id), 'name' => 'user_add_form', 'class' =>'', 'id' => 'user_add_form', 'method' => 'post','role'=>'','enctype'=>'multipart/form-data']) !!}
            ...
            <div class="row">
              ...
              <div class="form-group col-12 col-md-6">
                ...
                {!! Form::text('user_name',$data->name, ['class'=>'form-control','autocomplete'=>'off','maxlength'=>'100', 'id'=>'user_name', 'placeholder'=>'Enter User Name']) !!}
              </div>
              <div class="form-group col-12 col-md-6">
                {!! Form::label('user_email','Enter User Email',['class'=>'required']) !!}
                {!! Form::text('user_email',$data->email, ['class'=>'form-control','autocomplete'=>'off','maxlength'=>'100','id'=>'user_email', 'placeholder'=>'Enter User Email']) !!}
              </div>
              <div class="form-group col-12 col-md-6">
                {!! Form::label('user_mobile_no','Enter User Mobile No',['class'=>'required']) !!}
                {!! Form::text('user_mobile_no',$data->mobile_no, ['class'=>'form-control','autocomplete'=>'off','maxlength'=>'20','id'=>'user_mobile_no', 'placeholder'=>'Enter User Mobile No']) !!}
              </div>
            
              <div class="form-group col-12 col-md-6">
                {!! Form::label('user_dob','Enter Date Of Birth',['class'=>'required']) !!}
                {!! Form::text('user_dob', date('d/m/Y', strtotime($data->dob)), ['class'=>'form-control','autocomplete'=>'off','id'=>'user_dob', 'placeholder'=>'Enter Date Of Birth']) !!}
              </div>
              ...
              <div class="form-group col-12 col-md-12">
                <div class="custom-file custom_file_sec">
                    ...
                    <button type="button"><img src="{{ asset('storage/user_image/'.$data->prf_image) }}"  id="blah" width="240"  height="120"alt="blue"></button><br>
              ...
              <div class="form-group col-12 col-md-6">
                ...
                <option  value="{{$key}}" {{ ( $key ==  $data->user_type) ? 'selected' : '' }}>{{$value}}</option>
